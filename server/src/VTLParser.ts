...
export class VTLParser extends Parser {
	...
	public property_or_method(): Property_or_methodContext {
		let _localctx: Property_or_methodContext = new Property_or_methodContext(this._ctx, this.state);
	...
	public formal_property_or_method(): Formal_property_or_methodContext {
		let _localctx: Formal_property_or_methodContext = new Formal_property_or_methodContext(this._ctx, this.state);
	...
	public property_end(): Property_endContext {
		let _localctx: Property_endContext = new Property_endContext(this._ctx, this.state);
	...
	public set_directive(): Set_directiveContext {
		let _localctx: Set_directiveContext = new Set_directiveContext(this._ctx, this.state);
	...
	public foreach_directive(): Foreach_directiveContext {
		let _localctx: Foreach_directiveContext = new Foreach_directiveContext(this._ctx, this.state);
	...
	public break_directive(): Break_directiveContext {
		let _localctx: Break_directiveContext = new Break_directiveContext(this._ctx, this.state);
	...
	public stop_directive(): Stop_directiveContext {
		let _localctx: Stop_directiveContext = new Stop_directiveContext(this._ctx, this.state);
	...
	public custom_directive(): Custom_directiveContext {
		let _localctx: Custom_directiveContext = new Custom_directiveContext(this._ctx, this.state);
	...
	public macro_directive(): Macro_directiveContext {
		let _localctx: Macro_directiveContext = new Macro_directiveContext(this._ctx, this.state);
	...
	public parse_directive(): Parse_directiveContext {
		let _localctx: Parse_directiveContext = new Parse_directiveContext(this._ctx, this.state);
	...
	public define_directive(): Define_directiveContext {
		let _localctx: Define_directiveContext = new Define_directiveContext(this._ctx, this.state);
	...
	public include_directive(): Include_directiveContext {
		let _localctx: Include_directiveContext = new Include_directiveContext(this._ctx, this.state);
	...
	public evaluate_directive(): Evaluate_directiveContext {
		let _localctx: Evaluate_directiveContext = new Evaluate_directiveContext(this._ctx, this.state);
	...
	public macro_call_directive(): Macro_call_directiveContext {
		let _localctx: Macro_call_directiveContext = new Macro_call_directiveContext(this._ctx, this.state);
	...
	public map_entries(): Map_entriesContext {
		let _localctx: Map_entriesContext = new Map_entriesContext(this._ctx, this.state);
	...
	public map_entry(): Map_entryContext {
		let _localctx: Map_entryContext = new Map_entryContext(this._ctx, this.state);
